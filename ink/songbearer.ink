...
#add_shard:violin
~ violin_song = true
{The song swells and dances across the strings. You wonder if it's chasing something. <i> You found the Violin shard. </i>|The desk sags elaborately under its own weight.} 
-> command.choices
